/* ==========================================================================
   The measured scene: a rebuild of the reference clip.

   540x540, 25fps, 144 frames. The spine reproduces the finished scribble at
   IoU 0.96 once two corrections are read off the data: the true centerline sits
   6px below the visible dot, and the resting stroke bulges fatter than the pen
   in the valleys, so the spine carries the local half width measured off the
   resting scribble's distance transform ridge, not the tip radius.

   Tables here are read LINEARLY and the ease is named `measured` rather than
   `linear`, so nobody smooths them into a curve the reference never had.
   ========================================================================== */
